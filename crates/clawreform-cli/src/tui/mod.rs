//! Ratatui TUI for ClawReform interactive mode.
//!
...
enum Backend {
    ...
    InProcess { kernel: Arc<ClawReformKernel> },
    None,
}
...
impl App {
    ...
    fn handle_stream_done(
        &mut self,
        result: Result<clawreform_runtime::agent_loop::AgentLoopResult, String>,
    ) {
    ...
    fn handle_kernel_ready(&mut self, kernel: Arc<ClawReformKernel>) {
