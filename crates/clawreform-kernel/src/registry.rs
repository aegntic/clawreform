...
impl AgentRegistry {
    ...
    pub fn register(&self, entry: AgentEntry) -> ClawReformResult<()> {
        if self.name_index.contains_key(&entry.name) {
            return Err(ClawReformError::AgentAlreadyExists(entry.name.clone()));
        }
        let id = entry.id;
    ...
    /// Update agent state.
    pub fn set_state(&self, id: AgentId, state: AgentState) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
        entry.state = state;
    ...
    pub fn set_mode(&self, id: AgentId, mode: AgentMode) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn remove(&self, id: AgentId) -> ClawReformResult<AgentEntry> {
        let (_, entry) = self
            .agents
            .remove(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn update_session_id(
        &self,
        id: AgentId,
        new_session_id: clawreform_types::agent::SessionId,
    ) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
    ...
    pub fn update_identity(
        &self,
        id: AgentId,
        identity: clawreform_types::agent::AgentIdentity,
    ) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
    ...
    pub fn update_model(&self, id: AgentId, new_model: String) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn update_skills(&self, id: AgentId, skills: Vec<String>) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn update_mcp_servers(&self, id: AgentId, servers: Vec<String>) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn update_system_prompt(&self, id: AgentId, new_prompt: String) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn update_name(&self, id: AgentId, new_name: String) -> ClawReformResult<()> {
        if self.name_index.contains_key(&new_name) {
            return Err(ClawReformError::AgentAlreadyExists(new_name));
        }
        let mut entry = self
            .agents
            .get_mut(&id)
    ...
    pub fn update_description(&self, id: AgentId, new_desc: String) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
    ...
    pub fn mark_onboarding_complete(&self, id: AgentId) -> ClawReformResult<()> {
        let mut entry = self
            .agents
            .get_mut(&id)
            .ok_or_else(|| ClawReformError::AgentNotFound(id.to_string()))?;
