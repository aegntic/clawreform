...
use clawreform_memory::session::Session;
use clawreform_memory::MemorySubstrate;
use clawreform_skills::registry::SkillRegistry;
use clawreform_types::agent::AgentManifest;
use clawreform_types::error::{ClawReformError, ClawReformResult};
use clawreform_types::memory::{Memory, MemoryFilter, MemorySource};
use clawreform_types::message::{
    ContentBlock, Message, MessageContent, Role, StopReason, TokenUsage,
};
use clawreform_types::tool::{ToolCall, ToolDefinition};
...
///
/// This is the core of ClawReform: it loads session context, recalls memories,
...
pub async fn run_agent_loop(
...
) -> ClawReformResult<AgentLoopResult> {
    ...
    if let Some(hook_reg) = hooks {
        let ctx = crate::hooks::HookContext {
            ...
            event: clawreform_types::agent::HookEvent::BeforePromptBuild,
            ...
            StopReason::EndTurn | StopReason::StopSequence => {
                ...
                if stored_text.trim() == "NO_REPLY" || parsed_directives.silent {
                    ...
                    return Ok(AgentLoopResult {
                        ...
                        cost_usd: None,
                        silent: true,
                        directives: clawreform_types::message::ReplyDirectives {
                ...
                if let Some(hook_reg) = hooks {
                    let ctx = crate::hooks::HookContext {
                        agent_name: &manifest.name,
                        agent_id: agent_id_str.as_str(),
                        event: clawreform_types::agent::HookEvent::AgentLoopEnd,
                        data: serde_json::json!({
                            "iterations": iteration + 1,
                ...
                for tool_call in &response.tool_calls {
                    ...
                    match &verdict {
                        LoopGuardVerdict::CircuitBreak(msg) => {
                            ...
                            return Err(ClawReformError::Internal(msg.clone()));
                        }
                    ...
                    if let Some(hook_reg) = hooks {
                        let ctx = crate::hooks::HookContext {
                            ...
                            event: clawreform_types::agent::HookEvent::BeforeToolCall,
                            data: serde_json::json!({
                    ...
                    .await
                    {
                        ...
                        Err(_) => {
                            ...
                            clawreform_types::tool::ToolResult {
                                tool_use_id: tool_call.id.clone(),
                                content: format!(
                    ...
                    if let Some(hook_reg) = hooks {
                        let ctx = crate::hooks::HookContext {
                            ...
                            event: clawreform_types::agent::HookEvent::AfterToolCall,
                            data: serde_json::json!({
                                "tool_name": &tool_call.name,
    ...
    Err(ClawReformError::MaxIterationsExceeded(max_iterations))
}
...
) -> ClawReformResult<crate::llm_driver::CompletionResponse> {
    ...
    if let (Some(provider), Some(cooldown)) = (provider, cooldown) {
        match cooldown.check(provider) {
            CooldownVerdict::Reject {
                ...
                return Err(ClawReformError::LlmDriver(format!(
    ...
    for attempt in 0..=MAX_RETRIES {
        match driver.complete(request.clone()).await {
            ...
            Err(e) => {
                ...
                return Err(ClawReformError::LlmDriver(user_msg));
            }
        }
    }

    Err(ClawReformError::LlmDriver(
...
mod tests {
    ...
    fn test_manifest() -> AgentManifest {
        AgentManifest {
            ...
            model: clawreform_types::agent::ModelConfig {
