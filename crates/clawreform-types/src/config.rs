//! Configuration types for the ClawReform kernel.
...
impl Default for WebhookTriggerConfig {
    fn default() -> Self {
        Self {
            enabled: false,
            token_env: "CLAWREFORM_WEBHOOK_TOKEN".to_string(),
...
pub struct DockerSandboxConfig {
    ...
    pub image: String,
    /// Container name prefix. Default: "clawreform-sandbox".
...
impl Default for DockerSandboxConfig {
    fn default() -> Self {
        Self {
            ...
            container_prefix: "clawreform-sandbox".to_string(),
...
pub struct VaultConfig {
    ...
    pub enabled: bool,
    /// Custom vault file path (default: ~/.clawreform/vault.enc).
...
pub struct KernelConfig {
    /// ClawReform home directory (default: ~/.clawreform).
    pub home_dir: PathBuf,
    /// Data directory for databases (default: ~/.clawreform/data).
    ...
    /// Root directory for agent workspaces. Default: `~/.clawreform/workspaces`
    #[serde(default)]
...
pub struct MatrixConfig {
    ...
    /// Bot user ID (e.g., "@clawreform:matrix.org").
    pub user_id: String,
...
pub struct IrcConfig {
    ...
    /// Channels to join (e.g., `["#clawreform", "#general"]`).
...
mod tests {
    ...
    fn test_validate_missing_env_vars() {
        ...
        config.channels.discord = Some(DiscordConfig {
            bot_token_env: "CLAWREFORM_TEST_NONEXISTENT_VAR_DC".to_string(),
            ..Default::default()
        });
        let warnings = config.validate();
