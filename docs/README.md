...
| Path | Description |
|------|-------------|
| `~/.clawreform/config.toml` | Main configuration file |
| `~/.clawreform/data/clawreform.db` | SQLite database |
| `~/.clawreform/skills/` | Installed skills |
| `~/.clawreform/daemon.json` | Daemon PID and port info |
